...
set MYW_PYTHON_SITE_DIRS=%~dp0..\Externals\win32\Lib\site-packages;%~dp0..\WebApps;%MYW_PYTHON_SITE_DIRS%
...
set CLASSPATH=%BIN_DIR%;%BIN_DIR%\pngj-1.1.2\pngj.jar;%BIN_DIR%\sqlite4java-282\sqlite4java.jar;%CLASSPATH%
